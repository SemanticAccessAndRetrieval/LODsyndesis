...
public class Duplicates extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(configuration, new Duplicates(), args);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(Duplicates.class);
	...
	public static class Reduce extends
		...
		public void reduce(Text key, Iterable<Text> values,
			...
			System.out.println(key.toString()+docs.size());
			if(docs.size()>1){
				String k="";
				for(String p:docs)
					k+=p+",";
